...
class UserRegistrationViewTestCase(TestCase):
    ...
    def setUp(self):
        self.data = {
            'first_name': '123', 'last_name': '123', 'username': '123',
            'email': '123@mail.ru', 'password1': '12345678pP', 'password2': '12345678pP'
        }
    ...
    def test_user_registration_get(self):
        ...
        self.assertEqual(response.context_data['view'].template_name, 'users/register.html')
